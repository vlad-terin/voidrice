...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["copilot-cmp"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["which-key.nvim"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/which-key.nvim",
